...
const MyPerfilForm = ({ PerfilFact }: any) => {
    ...
    const values = {
        PER_NAME: PerfilFact.data.PER_NAME,
        PER_LASTNAME: PerfilFact.data.PER_LASTNAME,
        PER_N_PHONE: PerfilFact.data.PER_N_PHONE,
        PER_COUNTRY: PerfilFact.data.PER_COUNTRY,
        PER_DEPARTMENT: PerfilFact.data.PER_DEPARTMENT,
        PER_PROVINCE: PerfilFact.data.PER_PROVINCE,
        PER_DISTRIC: PerfilFact.data.PER_DISTRIC,
        PER_DIRECTION: PerfilFact.data.PER_DIRECTION,
        PER_EMAIL: PerfilFact.data.PER_EMAIL,
        PER_DNI: PerfilFact.data.PER_DNI,
    }
    const validate = yup.object().shape({
        PER_NAME: yup.string().required("Debe ingresar su nombre"),
        PER_LASTNAME: yup.string().required("Debe ingresar su apellido"),
        PER_N_PHONE: yup.string().required("Debe ingresar su apellido"),
        PER_COUNTRY: yup.string().required("Debe ingresar su apellido"),
        PER_DEPARTMENT: yup.string().required("Debe ingresar su apellido"),
        PER_PROVINCE: yup.string().required("Debe ingresar su apellido"),
        PER_DISTRIC: yup.string().required("Debe ingresar su apellido"),
        PER_DIRECTION: yup.string().required("Debe ingresar su apellido"),
        PER_EMAIL: yup.string().required("Debe ingresar su apellido"),
        PER_DNI: yup.string().required("Debe ingresar su apellido"),
    })
    const values2 = {
        USR_PASSWORD: "",
        USR_PASSWORD2: "",
