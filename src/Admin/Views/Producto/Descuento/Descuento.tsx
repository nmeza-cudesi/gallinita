                    ...
                    <FormLabel htmlFor="producto" width={{ base: "90%", md: "30%" }}>Insumo
                        ...
                        <InputGroup>
                            ...
                            {producto.isLoading ?
                                ...
                                :
                                <datalist id="datalist-prod">
                                    {!producto.data.message ? (producto.data).map((item: any) => { return <option value={item.PRO_BARCODE}> {item.PRO_NAME}</option> }) : <option disabled={true} value={producto.data.message}>404</option>}
                                </datalist>}
                        </InputGroup>
                    </FormLabel>
